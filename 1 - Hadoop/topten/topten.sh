...
# Compile and package
mkdir classes
CLASSPATH="$HADOOP_PREFIX"/share/hadoop/common/hadoop-common-2.7.1.jar:"$HADOOP_PREFIX"/share/hadoop/mapreduce/hadoop-mapreduce-client-core-2.7.1.jar:"$HADOOP_PREFIX"/share/hadoop/common/lib/commons-cli-1.2.jar​:"$HADOOP_PREFIX"/share/hadoop/tools/lib/log4j-1.2.17.jar
